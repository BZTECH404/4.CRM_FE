...
const gst = ['GST not Charged', "GST Charged Unpaid", "GST Paid", "GST to be Claimed", "GST Claimed"]
...
export { baseurl, toi, ProjectStatus, banknames, types, Agency, tds, gst, wards, companies, Acknowledgement, Forward, Type,database}
